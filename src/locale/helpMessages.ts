import IHelpMessages from '../../interfaces/locale/IHelpMessages';

const helpMessages: IHelpMessages = {
    regularMessage:
        'К сожалению, я могу рассказать что я умею, только если меня попросит администратор чата',
    adminMessage:
        ...
        '/noemoji - контролирует строгость удаления кастомных эмодзи\n' +
