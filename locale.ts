...
export const whiteListLocale = {
    ...
    noAccess: `Привет. К сожалению, я не могу у вас работать, так как мой создатель не дал мне разрешения на это. Я уже спросила, можно ли мне работать здесь, но вы можете узнать быстрее, написав ему лично: ${otherLocale['creatorLink']} (Укажите этот айди: xxx, когда будете обращаться к нему, чтобы быстрее разобраться)`,
    accessRemoved: `Привет. К сожалению, мой создатель отозвал разрешение на работу в этом чате. Если хотите узнать, что случилось, напишите ему лично: ${otherLocale['creatorLink']} (Укажите этот айди: xxx, когда будете обращаться к нему, чтобы быстрее разобраться)`,
    accessGranted:
...
export const ignoreListLocale = {
    ...
    noAccess: `Простите, но ваш чат был добавлен в список игнорируемых чатов! Я не могу тут находиться, поэтому мне придется уйти. Если хотите узнать в чем дело, напишите моему создателю: ${otherLocale['creatorLink']} (Укажите этот айди: xxx, когда будете обращаться к нему, чтобы быстрее разобраться)`,
